...
Before publishing a real package, replace the placeholder package metadata in `src/ReliableWebhooks/ReliableWebhooks.csproj`, especially `Authors` and `Description`.
