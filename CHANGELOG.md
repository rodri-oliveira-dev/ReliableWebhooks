...
- Backend-neutral observability with structured `ILogger` lifecycle events, `ActivitySource` delivery-attempt traces, `Meter` counters/histograms, stable public instrumentation names, and OpenTelemetry-ready integration without an exporter dependency.
